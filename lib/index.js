...
class PageReloadMonitor{
  ...
  reload(method, modKeys){
    ...
    console.log(data);
    console.log('had video? ', data.attributes['html5video']);
    console.log('last page title: ', data.attributes['page-title']);
  ...
  ask(hostname) {
    ...
    this.popPanel(function reactionCallback(r){
      ...
      console.log('reactionCallback', r);
